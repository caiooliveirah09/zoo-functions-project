...
describe('Testes da função getOpeningHours', () => {
  ...
  it('Teste não passando argumentos. Deverá retornar o objeto:', () => {
    expect(getOpeningHours()).toEqual(noArgumentsObject);
  });
  ...
  it('Para os argumentos Tuesday e 09:60-AM deve lançar uma exceção com a mensagem "The hour must be between 0 and 12"', () => {
